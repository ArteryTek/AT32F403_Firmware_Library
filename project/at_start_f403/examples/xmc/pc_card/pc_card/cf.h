...
#define FALSE                            0
#define TRUE                             1
#define XMC_BASE                         ((uint32_t)0x60000000)
#define XMC_BANK4_                       (XMC_BASE + 0x30000000)
#define PCCARD_DEVICE_ADDRESS            XMC_BANK4_
#define PCCARD_COMMON_SPACE_ADDRESS      PCCARD_DEVICE_ADDRESS
#define PCCARD_ATTRIBUTE_SPACE_ADDRESS   ((uint32_t)(XMC_BANK4_ + 0x08000000))
#define PCCARD_IO_SPACE_ADDRESS          ((uint32_t)(XMC_BANK4_ + 0x0C000000))
